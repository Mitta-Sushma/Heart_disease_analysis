...
This project is created for academic purposes and demonstrates data visualization, database integration, and full-stack web development.
📖 Introduction
...
⚠️ This project is for educational purposes only and not intended for medical diagnosis.
